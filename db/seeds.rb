...
Post.create!([
  ...
  {author_id: 3, blog_id: 2, title: "Puh-lease", body: "What are you, Morty, like, some sort of coward? We just need to smuggle some contraband and then get on that spaceship back home, Morty, and then it'll all be fine, and we can go on even MORE adventures! Won't that be great, Morty?"},
